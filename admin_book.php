<?php
	...
	$result = getAll($conn);
?>
	<center><p class="btn-btn-primary"><a href="admin_add.php">Add new book</a></p></center>
	<center><p class="btn-btn-primary">Check Existing Books</p></center>
  ...
  <center> <a href="admin_signout.php" class="btn btn-primary">Sign out!</a></center>
